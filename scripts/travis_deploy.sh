...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "phantomas1234/debug-memote-online-3" ]]; then
...
echo "Your new report will be visible at https://phantomas1234.github.io/debug-memote-online-3 in a moment."
